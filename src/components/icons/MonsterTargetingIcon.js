...
const MonsterTargetingIcon = ({ className, color, extraSmall, small, large, ...rest }) => {
  return (
    <svg
      className={clsx(
        'icon',
        { 'icon--extra-small': extraSmall },
        { 'icon--small': small },
        { 'icon--large': large },
        className
      )}
...
MonsterTargetingIcon.propTypes = {
...
export default MonsterTargetingIcon;
